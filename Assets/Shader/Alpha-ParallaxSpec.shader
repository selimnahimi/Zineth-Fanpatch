...
DP3 R0.x, fragment.texcoord[1], fragment.texcoord[1];
RSQ R3.z, R0.x;
MUL R1.xyz, R3.z, fragment.texcoord[1];
ADD R0.x, R1.z, c[4].y;
RCP R0.x, R0.x;
MUL R2.xyz, R2.w, R2;
MUL R2.xyz, R2, c[5].w;
...
MAD R3.xy, R0.z, R1, fragment.texcoord[0].zwzw;
MAD R0.xy, R0.z, R1, fragment.texcoord[0];
MAD R4.xyz, R3.z, fragment.texcoord[1], R4;
TEX R3.yw, R3, texture[2], 2D;
TEX R1, fragment.texcoord[2], texture[3], 2D;
TEX R0, R0, texture[1], 2D;
MAD R3.xy, R3.wyzw, c[4].z, -c[4].w;
MUL R2.w, R3.y, R3.y;
...
mul r5.xyz, r4.y, c6
mad r6.xyz, r4.x, c7, r5
mov r5.x, c5.y
mov r5.y, c5.z
mov r5.z, c5.w
mad r5.xyz, r4.z, r5, r6
dp3 r1.x, r5, r5
rsq r1.x, r1.x
mul r5.xyz, r1.x, r5
...
mov r6.y, r1
mov r6.x, r1.w
mad_pp r6.xy, r6, c4.z, c4.w
mul_pp r1.x, r6.y, r6.y
mad_pp r0.x, -r6, r6, -r1
dp3_pp r1.x, r5, r5
add_pp r0.x, r0, c5
rsq_pp r0.x, r0.x
rcp_pp r6.z, r0.x
