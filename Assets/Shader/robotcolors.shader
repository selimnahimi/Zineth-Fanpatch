...
//
///////////////////////////////////////////
Shader "RobotColorBlend" {
Properties {
 _MainTex ("Base (RGB) Gloss (A)", 2D) = "white" {}
 _Color ("Main Color", Color) = (1,0,0,1)
 _Cutoff ("Cutoff", Float) = 0.7
 _Color2 ("Color2", Color) = (1,0,0,1)
 _Cutoff2 ("Cutoff2", Float) = 0.55
}
SubShader { 
...
SLT R1.x, c[2], R0.w;
ABS R1.x, R1;
CMP R1.w, -R1.x, c[5].y, c[5].x;
SLT R0.w, c[4].x, R0;
MUL R2.x, R0.w, R1.w;
MUL R1.xyz, R0, c[1];
CMP R1.xyz, -R2.x, R1, R0;
ABS R0.w, R0;
CMP R0.w, -R0, c[5].y, c[5].x;
MUL R0.w, R0, R1;
MUL R0.xyz, R0, c[3];
CMP R1.xyz, -R0.w, R0, R1;
MAX R1.w, fragment.texcoord[1].z, c[5].y;
MUL R0.xyz, R1.w, c[0];
...
SLT R3.x, c[1], R0.w;
ABS R3.x, R3;
CMP R3.w, -R3.x, c[4], c[4].z;
SLT R0.w, c[3].x, R0;
MUL R4.x, R0.w, R3.w;
MUL R3.xyz, R0, c[0];
CMP R3.xyz, -R4.x, R3, R0;
ABS R0.w, R0;
CMP R0.w, -R0, c[4], c[4].z;
MUL R2.xyz, R2.w, R2;
MUL R0.w, R0, R3;
MUL R0.xyz, R0, c[2];
...
dcl_2d s1
dcl_2d s2
def c4, 0.00000000, 1.00000000, 0.57735026, 8.00000000
dcl t0.xy
dcl t1.xy
texld r4, t1, s1
texld r5, t0, s0
...
mul_pp r0.x, r0, r1
mul r6.xyz, r5, c0
cmp_pp r2.xyz, -r2.x, r5, r6
mul r1.xyz, r5, c2
cmp_pp r1.xyz, -r0.x, r2, r1
mul_pp r3.xyz, r3.w, r3
mul_pp r0.xyz, r3, c4.z
dp3_pp r0.x, r0, c4.w
...
MUL R2.y, R0.w, R1.w;
MUL R1.xyz, R0, c[1];
CMP R1.xyz, -R2.y, R1, R0;
ABS R0.w, R0;
CMP R0.w, -R0, c[5].y, c[5].x;
MUL R0.w, R0, R1;
MUL R2.yzw, R0.xxyz, c[3].xxyz;
MAX R1.w, fragment.texcoord[1].z, c[5].y;
CMP R1.xyz, -R0.w, R2.yzww, R1;
MUL R0.xyz, R1.w, c[0];
MUL R2.xyz, R2.x, R0;
MUL R0.xyz, R1, fragment.texcoord[2];
MUL R1.xyz, R2, R1;
MAD result.color.xyz, R1, c[5].z, R0;
MOV result.color.w, c[1];
END
...
ABS R2.y, R2;
MUL R3.xyz, R1, c[0];
CMP R3.w, -R2.y, c[4].y, c[4].x;
SLT R1.w, c[3].x, R1;
MUL R2.y, R1.w, R3.w;
CMP R2.yzw, -R2.y, R3.xxyz, R1.xxyz;
MUL R3.xyz, R0, R2.x;
MUL R0.xyz, R0.w, R0;
ABS R0.w, R1;
CMP R0.w, -R0, c[4].y, c[4].x;
...
MUL R2.xyz, R2.w, R2;
MUL R3.yzw, R2.xxyz, c[4].y;
MUL R2.xyz, R1, R3.x;
MUL R1.xyz, R1.w, R1;
DP3 R2.w, R3.yzww, c[4].x;
MUL R3.yzw, R1.xxyz, R2.w;
MUL R1.xyz, R2, c[5].x;
MUL R2.xyz, R3.yzww, c[4].x;
MIN R1.xyz, R2, R1;
MUL R2.xyz, R2, R3.x;
MAX R1.xyz, R1, R2;
SLT R2.x, c[3], R0.w;
SLT R1.w, c[1].x, R0;
ABS R1.w, R1;
CMP R0.w, -R1, c[4], c[4].z;
ABS R2.w, R2.x;
MUL R1.w, R0, R2.x;
MUL R2.xyz, R0, c[0];
CMP R2.xyz, -R1.w, R2, R0;
CMP R2.w, -R2, c[4], c[4].z;
MUL R0.w, R0, R2;
MUL R0.xyz, R0, c[2];
CMP R0.xyz, -R0.w, R0, R2;
...
mul_pp r3.x, r0, r2
mul r5.xyz, r1, c0
cmp_pp r3.xyz, -r3.x, r1, r5
abs_pp r2.x, r2
cmp_pp r2.x, -r2, c4.y, c4
mul r1.xyz, r1, c2
mul_pp r0.x, r0, r2
cmp_pp r0.xyz, -r0.x, r3, r1
mul_pp r0.xyz, r0, r4
mov_pp r0.w, c0
mov_pp oC0, r0
"
...
RSQ R2.y, R2.y;
CMP R0.w, -R0, c[5].y, c[5].x;
MUL R2.y, R2, fragment.texcoord[1].z;
MUL R0.w, R0, R2.x;
MAX R2.x, R2.y, c[5].y;
MUL R0.xyz, R0, c[3];
...
MAD R1.zw, fragment.texcoord[3].xyxy, R0.x, c[5].z;
DP3 R1.x, fragment.texcoord[3], fragment.texcoord[3];
MOV result.color.w, c[5].y;
TEX R0, fragment.texcoord[0], texture[0], 2D;
...
CMP R2.z, -R2.y, c[5].y, c[5].x;
RSQ R2.y, R0.w;
MUL R0.w, R2.z, R2.x;
MUL R2.x, R2.y, fragment.texcoord[1].z;
MUL R0.xyz, R0, c[3];
CMP R0.xyz, -R0.w, R0, R1;
MAX R2.x, R2, c[5].y;
SLT R0.w, c[5].y, fragment.texcoord[3].z;
MUL R0.w, R0, R1;
MUL R1.xyz, R2.x, c[0];
MUL R0.w, R0, R2;
MUL R1.xyz, R0.w, R1;
...
CMP R0.w, -R0, c[5].y, c[5].x;
MUL R0.w, R0, R2.x;
MAX R2.x, fragment.texcoord[1].z, c[5].y;
MUL R0.xyz, R0, c[3];
CMP R0.xyz, -R0.w, R0, R1;
MUL R2.xyz, R2.x, c[0];
MUL R1.xyz, R1.w, R2;
...
SLT R1.w, c[1].x, R0;
ABS R1.w, R1;
CMP R1.w, -R1, c[4].y, c[4].x;
SLT R0.w, c[3].x, R0;
MUL R2.w, R0, R1;
MUL R2.xyz, R0, c[0];
CMP R2.xyz, -R2.w, R2, R0;
ABS R0.w, R0;
CMP R0.w, -R0, c[4].y, c[4].x;
LG2 R1.x, R1.x;
LG2 R1.z, R1.z;
...
RCP R1.w, R1.w;
MUL R4.xyz, R0, c[0];
CMP R3.w, -R3, c[5].y, c[5].x;
SLT R0.w, c[3].x, R0;
MUL R4.w, R0, R3;
CMP R4.xyz, -R4.w, R4, R0;
ABS R0.w, R0;
CMP R0.w, -R0, c[5].y, c[5].x;
MUL R1.xyz, R1, c[5].z;
MUL R2.xyz, R2.w, R2;
