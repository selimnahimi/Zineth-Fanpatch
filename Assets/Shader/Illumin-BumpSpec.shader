...
MAD R1.xyz, R2.z, fragment.texcoord[4], R1;
DP3 R2.z, R1, R1;
RSQ R2.z, R2.z;
MUL R1.xyz, R2.z, R1;
RSQ R1.w, R1.w;
...
MOV R1.w, c[4];
MUL R3.z, R3.y, R3.y;
MAD R4.xyz, R3.w, fragment.texcoord[3], R4;
...
MAD R2.xyz, R0.z, fragment.texcoord[4], R2;
DP3 R0.z, R2, R2;
RSQ R0.z, R0.z;
MUL R2.xyz, R0.z, R2;
DP3 R0.z, R3, R2;
...
RSQ R4.w, R4.w;
MAD R5.xyz, R4.w, fragment.texcoord[4], R5;
MUL R4.z, R4.y, R4.y;
