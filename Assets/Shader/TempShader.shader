...
dcl_2d s1
dcl_2d s2
def c2, 0.00000000, 1.00000000, 0.57735026, 8.00000000
dcl t0.xy
dcl t1.xy
texld r3, t1, s1
texld r4, t0, s0
...
MUL R1.xyz, R0, -R1.w;
MUL R0.xyz, R0, c[1];
MUL R2.yzw, R1.w, R0.xxyz;
MAX R0.w, fragment.texcoord[1].z, c[3].x;
MAX R1.xyz, R1, R2.yzww;
MUL R0.xyz, R0.w, c[0];
MUL R2.xyz, R2.x, R0;
...
RSQ R2.x, R0.z;
MUL R2.x, R2, fragment.texcoord[1].z;
MAX R2.x, R2, c[3];
SLT R0.y, -R1.w, -c[2].x;
MUL R2.xyz, R2.x, c[0];
...
MAX R0.xyz, R1, R0;
MUL R1.xyz, R0.w, c[0];
SLT R0.w, c[3].x, fragment.texcoord[3].z;
MUL R0.w, R0, R1;
MUL R0.w, R0, R2;
MUL R1.xyz, R0.w, R1;
MUL R0.xyz, R1, R0;
...
ADD R0.x, -R1.w, c[2];
MAX R2.x, fragment.texcoord[1].z, c[3];
SLT R0.y, -R1.w, -c[2].x;
SLT R0.x, c[3], R0;
ADD R1.w, R0.x, -R0.y;
MUL R0.xyz, R1, -R1.w;
