...
texld r1.yw, r0, s2
mad_pp r2.xy, r1.wyzw, c4.z, c4.w
...
TEX R0.w, fragment.texcoord[0].zwzw, texture[0], 2D;
MAD R0.w, R0, c[2].x, -R0.x;
MAD R0.xy, R0.w, R2, fragment.texcoord[0].zwzw;
TEX R1.yw, R0, texture[2], 2D;
MAD R3.xy, R1.wyzw, c[3].z, -c[3].w;
MUL R0.x, R3.y, R3.y;
MAD R0.x, -R3, R3, -R0;
ADD R0.x, R0, c[3].w;
RSQ R0.x, R0.x;
...
MUL R0.xyz, R0, R1.w;
MUL R0.xyz, R0, R1;
MAD result.color.xyz, R0, c[4].w, R2;
MOV result.color.w, R2;
END
...
dcl_2d s5
def c3, 0.50000000, 0.41999999, 2.00000000, -1.00000000
def c4, 1.00000000, -0.40824828, -0.70710677, 0.57735026
def c5, -0.40824831, 0.70710677, 0.57735026, 8.00000000
...
mad r0.xy, r0.w, r2, v0.zwzw
texld r1.yw, r0, s2
mad_pp r3.xy, r1.wyzw, c3.z, c3.w
...
mul_pp r2, r2, c1
mul_pp r0.xyz, r0.w, r0
dp3_pp_sat r4.z, r3, c4.yzww
dp3_pp_sat r4.y, r3, c5
dp3_pp_sat r4.x, r3, c6
mul_pp r0.xyz, r0, r4
dp3_pp r1.w, r0, c5.w
texld r0, v5, s4
mul_pp r0.xyz, r0.w, r0
...
DP3 R0.z, R0, fragment.texcoord[5];
MAD R0.xy, R0.w, R2, fragment.texcoord[0];
...
MUL R0.w, R0.z, R0.x;
MUL R0.xyz, R2, c[0];
MUL R2.xyz, R2, fragment.texcoord[6];
MUL R0.xyz, R0.w, R0;
...
mad r0.xy, r0.w, r2, v0.zwzw
texld r1.yw, r0, s2
mad_pp r0.xy, r1.wyzw, c4.z, c4.w
mul_pp r0.z, r0.y, r0.y
mad_pp r0.z, -r0.x, r0.x, -r0
add_pp r0.z, r0, c5.x
rsq_pp r0.z, r0.z
...
MUL R0.x, R0, c[4].y;
TEX R0.w, fragment.texcoord[0].zwzw, texture[0], 2D;
MAD R1.w, R0, c[3].x, -R0.x;
MAD R0.zw, R1.w, R2.xyxy, fragment.texcoord[0];
TEX R0.yw, R0.zwzw, texture[2], 2D;
MOV R0.x, c[5];
MAD R0.xy, R0.wyzw, c[4].w, -R0.x;
MUL R0.z, R0.y, R0.y;
MAD R0.z, -R0.x, R0.x, -R0;
...
RCP R0.z, R0.z;
DP3 R0.x, R0, R1;
MAD R0.zw, R1.w, R2.xyxy, fragment.texcoord[0].xyxy;
MAX R1.x, R0, c[4];
...
MAD R1.zw, fragment.texcoord[3].xyxy, R0.w, c[4].y;
...
mul_pp r1.xyz, r0, c1
rcp r0.w, v3.w
mad r2.xy, v3, r0.w, c3.x
dp3 r0.x, v3, v3
texld r0.w, r2, s4
cmp r0.y, -v3.z, c4, c4.x
mul_pp r0.y, r0, r0.w
texld r0.x, r0.x, s5
mul_pp r0.x, r0.y, r0
mul_pp r1.xyz, r1, c0
...
MAD R0.zw, R0.z, R0.xyxy, fragment.texcoord[0].xyxy;
...
MAD R2.xy, R0.w, R2, fragment.texcoord[0];
...
dcl_2d s5
dcl_2d s6
def c4, 0.50000000, 0.41999999, 8.00000000, 1.00000000
...
RSQ R0.x, R0.x;
RCP R3.z, R0.x;
DP3 R1.x, R3, fragment.texcoord[3];
DP3 R1.y, R3, fragment.texcoord[4];
DP3 R1.z, R3, fragment.texcoord[5];
MAD R2.xy, R0.w, R2, fragment.texcoord[0];
MOV R0.x, fragment.texcoord[3].w;
MOV R0.z, fragment.texcoord[5].w;
MOV R0.y, fragment.texcoord[4].w;
