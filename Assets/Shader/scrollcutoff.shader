...
Properties {
 ...
 _Cutoff ("Alpha Cutoff", Range(0,1)) = 0.265
 _Alpha ("_Alpha", Float) = 1
}
SubShader { 
 Tags { "QUEUE"="Overlay" "IGNOREPROJECTOR"="False" "RenderType"="TransparentCutout" }
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardBase" "QUEUE"="Overlay" "IGNOREPROJECTOR"="False" "RenderType"="TransparentCutout" }
Program "vp" {
SubProgram "opengl " {
...
KIL -R0.w;
MAX R0.w, fragment.texcoord[1].z, c[5].x;
MUL R1.xyz, R0.w, c[1];
MUL R0.xyz, R1, R0;
MAD result.color.xyz, R0, c[5].y, R2;
END
...
MOV R0.x, c[0];
MAD R0.y, R0.x, c[1].x, fragment.texcoord[0];
MOV R0.x, fragment.texcoord[0];
MUL R1.xyz, R1.w, R1;
...
"
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardAdd" "QUEUE"="Overlay" "IGNOREPROJECTOR"="False" "RenderType"="TransparentCutout" }
  ZWrite Off
  Fog {
   Color (0,0,0,0)
  }
...
MAD R1.xy, fragment.texcoord[3], R1.x, c[5].y;
...
MAD R0.y, R0.x, c[2].x, fragment.texcoord[0];
MOV R0.x, fragment.texcoord[0];
MAX R1.x, fragment.texcoord[1].z, c[5];
MUL R1.xyz, R1.x, c[1];
MOV result.color.w, c[5].x;
TEX R0, R0, texture[0], 2D;
SLT R0.w, R0, c[3].x;
...
"
 ...
 Pass {
  Name "PREPASS"
  Tags { "LIGHTMODE"="PrePassBase" "QUEUE"="Overlay" "IGNOREPROJECTOR"="False" "RenderType"="TransparentCutout" }
  Fog { Mode Off }
Program "vp" {
SubProgram "opengl " {
Bind "vertex" Vertex
...
"
 ...
 Pass {
  Name "PREPASS"
  Tags { "LIGHTMODE"="PrePassFinal" "QUEUE"="Overlay" "IGNOREPROJECTOR"="False" "RenderType"="TransparentCutout" }
  ZWrite Off
Program "vp" {
SubProgram "opengl " {
