...
mul r0.xy, r0, r1.w
mul r1.xyz, r3.y, c6
mad r1.xyz, r3.x, c7, r1
mov_pp r0.z, c4.x
mad r1.xyz, r3.z, c5.yzww, r1
texld r1.w, v0.zwzw, s0
mul_pp r0.z, c3.x, r0
mad_pp r0.z, r1.w, c3.x, -r0
...
max_pp r0.w, r0, c7.y
pow r1, r0.w, r2.w
dp3_pp_sat r1.w, r2, c5.yzww
dp3_pp_sat r1.z, r2, c6
dp3_pp_sat r1.y, r2, c7
dp3_pp r0.w, r1.yzww, r3
texld r2, v2, s3
...
MUL R0.x, R0, c[5];
TEX R0.w, fragment.texcoord[0].zwzw, texture[0], 2D;
MAD R1.w, R0, c[4].x, -R0.x;
MAD R0.xy, R1.w, R2, fragment.texcoord[0].zwzw;
TEX R0.yw, R0, texture[2], 2D;
MAD R1.xy, R0.wyzw, c[5].z, -c[5].w;
MUL R0.w, R1.y, R1.y;
MAD R0.w, -R1.x, R1.x, -R0;
MOV R0.xyz, fragment.texcoord[2];
MAD R0.xyz, R1.z, fragment.texcoord[1], R0;
DP3 R1.z, R0, R0;
RSQ R1.z, R1.z;
ADD R0.w, R0, c[5];
MUL R0.xyz, R1.z, R0;
...
RSQ R1.y, R1.y;
MUL R0.xyz, R1.y, R0;
MAD R3.xyz, R1.z, fragment.texcoord[1], R0;
MAD R1.x, -R2, R2, -R1;
ADD R1.x, R1, c[4].w;
RSQ R0.x, R1.x;
RCP R2.z, R0.x;
...
mov r1.w, r2.x
mul_pp r2.xyz, r0.yzww, c0
mad r3.xy, r3.z, r3, v0
texld r0, r3, s1
...
RCP R0.y, R0.x;
MUL R3.xyz, R1.y, c[6];
MAD R3.xyz, R1.x, c[7], R3;
MAD R3.xyz, R1.z, c[5], R3;
DP3 R1.w, R3, R3;
RSQ R1.w, R1.w;
MUL R3.xyz, R1.w, R3;
MOV R0.x, c[3];
MUL R2.xy, R2, R0.y;
MAD R3.xyz, R0.z, fragment.texcoord[1], R3;
MUL R0.x, R0, c[4];
TEX R0.w, fragment.texcoord[0].zwzw, texture[0], 2D;
MAD R2.z, R0.w, c[3].x, -R0.x;
MAD R0.xy, R2.z, R2, fragment.texcoord[0].zwzw;
TEX R0.yw, R0, texture[2], 2D;
MAD R0.xy, R0.wyzw, c[4].z, -c[4].w;
MUL R0.w, R0.y, R0.y;
MAD R0.z, -R0.x, R0.x, -R0.w;
DP3 R0.w, R3, R3;
RSQ R0.w, R0.w;
ADD R0.z, R0, c[4].w;
RSQ R0.z, R0.z;
...
MUL R1.xyz, R1, c[4].z;
MAD R2.xyz, R0, c[4].z, -R1;
DP4 R0.y, fragment.texcoord[4], fragment.texcoord[4];
RSQ R0.w, R0.y;
DP3 R0.x, fragment.texcoord[1], fragment.texcoord[1];
RSQ R0.x, R0.x;
MUL R0.xyz, R0.x, fragment.texcoord[1];
